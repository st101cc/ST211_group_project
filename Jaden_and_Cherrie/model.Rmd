...
cleaned data
```{r}
data<-read.csv("W8QDEB2_cleaned.csv",header = TRUE, stringsAsFactors=TRUE)
head(data)
summary(data)
```

binary_vars <- c("W1hea2MP", "W1usevcHH", "IndSchool", "W1truantYP", "W1alceverYP", "W1bulrc",
                 "W5JobYP", "W5EducYP", "W5Apprent1YP", "W6JobYP", "W6UnivYP", "W6EducYP",
                 "W6Apprent1YP", "W6OwnchiDV", "W6Childliv")
...
model.interaction <- lm(W8QDEB2 ~ W1GrssyrHH * W1NoldBroHS + W1GrssyrHH * IndSchool +
                          W1NoldBroHS * W4RacismYP + IndSchool * W4RacismYP, data = data)
